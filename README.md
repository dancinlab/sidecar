...
61 plugins across `{hook · command · skill · mcp}` — one concept each (27 `core` · 17 `hexa` · 17 `personal`). The **Tier** column is the [enable profile](#profiles) a plugin belongs to.
