...
| [`domain`](skills/domain/) | skill + command | 0.1.0 | Maintain UPPERCASE `<DOMAIN>.md` files at project root as living current-state snapshots — overwrite, NOT append; no history inside the file (git log is the only chronological record). `/domain <NAME> [update]` or NL trigger. Examples: `ROADMAP.md` · `STATUS.md` · `PLAN.md` · `GOAL.md` · `ARCHITECTURE.md` · `DECISIONS.md`. |
