...
`/gap` — multi-axis gap exploration. Sweeps the current work through **40 breakthrough-strategy lenses** curated into **8 families** from the archived hive repo's `state/*_audit` catalogue.
...
## Families (8) — each carries 5 lenses
...
4. **F4 Epistemic-Evidence** — what do we know? (assumption-surfacing · bayesian · counterfactual · falsifier · honesty-triad)
5. **F5 Convergence-Closure** — is it done? (fixpoint · success-criteria · closed-loop · regression-streak · defense-in-depth)
6. **F6 Simplicity-Canonical** — less, single-sourced (minimum-viable · architectural-simplicity · canonical-ssot · duplicated-helper · surgical-scope)
