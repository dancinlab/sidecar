...
argument-hint: "[show | add <ssh-target> [linux|macos] [workdir] | rm <ssh-target> | workdir <remote-path|auto> | fallback <remote-path> | autosync on|off|mirror | patterns <regex> | off]"
allowed-tools: Bash
